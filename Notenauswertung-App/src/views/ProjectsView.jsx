        ...
        <div className="view-toolbar-block exams-toolbar">
          ...
          <div className="projects-meta-settings course-meta-settings-row">
            <div className="projects-meta-settings__row projects-meta-settings__row--top">
              ...
              {projectMetaActions('projects-meta-field--actions-slot')}
            </div>

            <div className="projects-meta-settings__row projects-meta-settings__row--details">
              ...
              <div className="projects-meta-settings__row projects-meta-settings__row--weighting">
...
function ProjectScoresTable({
  ...
  const stickyHeadTopR1 = isGroupMode ? undefined : 'calc(var(--header-height) + 105px)';
  const stickyHeadTopR2 = isGroupMode ? undefined : 'calc(var(--header-height) + 146px)';
  const stickyHeadSideR1 = isGroupMode
    ? {}
    : { position: 'sticky', top: stickyHeadTopR1, zIndex: 61 };
                ...
                <tr style={{ transition: 'background 0.2s', background: isExpanded ? 'rgba(79, 70, 229, 0.05)' : '' }}>
                  ...
                  <td
                    ...
                    style={{
                      width: '100px',
                      minWidth: '100px',
                      ...(isGroupMode ? {} : { position: 'sticky', right: 0, zIndex: 1 }),
                      ...
                      >
                        ...
                        <td
                          ...
                          style={{
                            width: '100px',
                            minWidth: '100px',
                            ...(isGroupMode ? {} : { position: 'sticky', right: '100px', zIndex: 1 }),
                            background: 'var(--surface)',
                            borderLeft: '1px solid var(--border)',
                            borderRight: '1px solid var(--border)',
                          }}
