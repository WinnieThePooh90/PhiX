...
const NOTENSYSTEM_HELP_TEXT =
  'Beim Wechsel werden gespeicherte manuelle Noten (Endnote, mündliche Note, GFS) automatisch umgerechnet und in der Datenbank im jeweiligen Format abgelegt (klassisch: Viertelnoten als Text, Punktesystem: ganze Zahlen 0–15). Beim Wechsel auf Punktesystem erhalten Klausuren mit Schlüssel 1 den Standard „ABI BaWü 2026 120 BE“; beim Wechsel zurück auf klassisch werden Klausuren mit diesem Standard wieder auf Schlüssel 1 gesetzt. Andere Schlüssel bleiben unverändert. Neu angelegte Klausuren nutzen standardmäßig Schlüssel 1 (klassisch) bzw. ABI BaWü 2026 120 BE (Punktesystem).';
